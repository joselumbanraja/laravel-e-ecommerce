        ...
        <div class="modal-content modal-md">
            ...
            <form action="{{ route('addDataUser') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="name" class="col-sm-5 col-form-label">Nama User</label>
                        <div class="col-sm-7">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-sm-5 col-form-label">Email User</label>
                        <div class="col-sm-7">
                            <input type="email" class="form-control" id="email" name="email" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="password" class="col-sm-5 col-form-label">Password User</label>
                        <div class="col-sm-7">
                    ...
                    <div class="mb-3 row">
                        <label for="alamat" class="col-sm-5 col-form-label">Alamat User</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="alamat" name="alamat">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tlp" class="col-sm-5 col-form-label">Telphone User</label>
                        <div class="col-sm-7">
